...
def TakeImages():        
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        harcascadePath = "rpalm.xml"    ###palm for palm and facecascasde for face
...
def TrackImages():
    ...
    harcascadePath = "rpalm.xml"  ##facecadcade for face detection
    ...
    fileName="Attendance/Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"   #it is working...
...
copyWrite.insert("insert", "Developed by Sukhi","", "TEAM", "superscript")
